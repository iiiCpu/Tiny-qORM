...
/**
 * @brief The ORMValue struct
 * Base struct for common ROWID based classes
 * Just subclass it with your structure and keep coding
 * If you want to use ROWIDs and don't want subclass ORMValue,
 * add writable and storable 'orm_rowid' property to your class
 */
struct ORMValue {
    Q_GADGET
